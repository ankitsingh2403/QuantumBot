...
const allowedOrigins = (process.env.ALLOWED_ORIGINS || process.env.DOMAIN || "http://localhost:5173,http://localhost:5174,http://localhost:5175,http://localhost:5176").split(",").map(s => s.trim());
